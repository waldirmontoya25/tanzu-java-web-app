...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=ftovaro&repo=tanzu-java-web-app-2",
  "projectName" : "tanzu-java-web-app",
  "repositoryPrefix" : "index.docker.io/ftovar377"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->index.docker.io/ftov...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=ftovaro&repo=tanzu-java-web-app-2'
